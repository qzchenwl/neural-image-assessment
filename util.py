...
def parse_function(filename, label):
    ...
    smallest_side = 256.0
    scale = smallest_side / img.width if img.height > img.width else smallest_side / height

    resized_img = img.resize((img.width * scale, img.height * scale), PIL.Image.BILINEAR)
